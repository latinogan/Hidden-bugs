...
const box1 = document.queryelector('.contenido');
box1.innerHTML = `   
...
const formEmail = document.querySelector('#eemail');
...
.from(form.elements).forEach((formElement) => formElement.addEventListener('input', loadData));